      ...
      <div className="relative">
        ...
        <div className= "gap-8 row-2 lg:columns-2 mt-[50px]">
          ...
          <div className="gap-8 rows-2 p-4 sm:p-10">
            <p className="text-xl 2xl:text-3xl lg:text-2xl"><b></b>A 72-hour event bringing together brilliant minds to solve challenges provided by companies.
With expert mentors, data, and the opportunity to win amazing prizes, this is a can't-miss opportunity for anyone looking to make a difference and test yourself. </p>
            <div className="gap-4 columns-2 2xl:text-4xl lg:text-3xl text-xl font-bold mt-[15px] pr-2">
              <div className="flex-row">
                ...
                <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base">International </p>
                <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base">Hackathon</p>
              </div>
              <div className="flex items-start gap-2 ">
                <p className="2xl:text-7xl lg:text-6xl text-2xl">SDG</p>
                <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base mt-[25px]">Related Workshops</p>
              </div>
            </div>
          </div>
        </div>
